/// \file Regmap_default_PLL2_40mhz_input_240mhz_output.h
/// \brief Definition of register map needed for CRU Configuration
///
/// \author Kostas Alexopoulos (kostas.alexopoulos@cern.ch)

std::vector<std::pair<uint32_t, uint32_t>> getLocalClockRegisterMap() {
  std::vector<std::pair<uint32_t, uint32_t>> registerMap = {
/*# Si538x/4x Registers Script
# 
# Part: Si5345
# Project File: C:\Users\cachemi\Desktop\PLLs\PCIe40_LLI_programming_data\jitter2_input0_40MHz\Si5345-RevD-JIT2_40-Project_jitter2_input0_40MHz.slabtimeproj
# Design ID: JIT2_40
# Includes Pre/Post Download Control Register Writes: Yes
# Die Revision: B1
# Creator: ClockBuilder Pro v2.20 [2017-11-21]
# Created On: 2018-01-20 21:28:42 GMT+01:00
#Address,Data
# 
...
# Start configuration registers*/
    ...
    std::make_pair(0x0096,0xA0),
    std::make_pair(0x0098,0xA0),
    std::make_pair(0x009A,0x02),
    std::make_pair(0x009B,0x70),
    std::make_pair(0x009D,0x0C),
    std::make_pair(0x009E,0xA0),
    std::make_pair(0x00A0,0x80),
    std::make_pair(0x00A2,0x00),
    std::make_pair(0x00A9,0x4D),
    std::make_pair(0x00AA,0xD2),
    std::make_pair(0x00AB,0x00),
    std::make_pair(0x00AC,0x00),
    std::make_pair(0x00E5,0x21),
    std::make_pair(0x00EA,0xF8),
    std::make_pair(0x00EB,0xCE),
    ...
    std::make_pair(0x013A,0x01),
    std::make_pair(0x013B,0x09),
    std::make_pair(0x013C,0x3B),
    std::make_pair(0x013D,0x28),
    ...
    std::make_pair(0x026B,0x4A),
    std::make_pair(0x026C,0x49),
    std::make_pair(0x026D,0x54),
    std::make_pair(0x026E,0x32),
    std::make_pair(0x026F,0x5F),
    std::make_pair(0x0270,0x34),
    std::make_pair(0x0271,0x30),
    ...
    std::make_pair(0x0508,0x14),
    std::make_pair(0x0509,0x22),
    std::make_pair(0x050A,0x0D),
    std::make_pair(0x050B,0x0C),
    std::make_pair(0x050C,0x01),
    std::make_pair(0x050D,0x3F),
    std::make_pair(0x050E,0x18),
    std::make_pair(0x050F,0x2C),
    std::make_pair(0x0510,0x09),
    std::make_pair(0x0511,0x08),
    std::make_pair(0x0512,0x01),
    ...
    std::make_pair(0x053D,0x12),
    std::make_pair(0x053E,0x06),
    std::make_pair(0x0589,0x0E),
    std::make_pair(0x058A,0x00),
    std::make_pair(0x059B,0xFA),
    std::make_pair(0x059D,0x14),
    std::make_pair(0x059E,0x24),
    std::make_pair(0x059F,0x0D),
    std::make_pair(0x05A0,0x0C),
    std::make_pair(0x05A1,0x01),
