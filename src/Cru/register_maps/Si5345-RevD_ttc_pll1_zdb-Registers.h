/// \file Si5345-RevD_ttc_pll1_zdb-Registers.h
/// \brief Definition of register map needed for CRU configuration
///
/// \author Kostas Alexopoulos (kostas.alexopoulos@cern.ch)

std::vector<std::pair<uint32_t, uint32_t>> getTtcClockPll1RegisterMap() {
  std::vector<std::pair<uint32_t, uint32_t>> registerMap = {

/*# Si538x/4x Registers Script
# 
# Part: Si5345
# Project File: C:\Users\Tuan\Documents\work\cern\dev\Si5345-RevD-Project_ttc_pll1_zdb.slabtimeproj
# Design ID: <none>
# Includes Pre/Post Download Control Register Writes: Yes
# Die Revision: B1
# Creator: ClockBuilder Pro v2.29 [2018-11-04]
# Created On: 2019-01-14 10:46:10 GMT+01:00
Address,Data
# 
...
# Start configuration registers*/
    ...
    std::make_pair(0x0130,0x01),
    std::make_pair(0x0131,0x09),
    std::make_pair(0x0132,0x3B),
    std::make_pair(0x0133,0x28),
