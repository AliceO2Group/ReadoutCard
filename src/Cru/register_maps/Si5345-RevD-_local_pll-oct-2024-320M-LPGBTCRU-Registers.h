...
/// \file Si5345-RevD-_local_pll-oct-2024-320M-LPGBTCRU-Registers.h
/// \brief Definition of register map needed for CRU configuration
///
/// cf https://gitlab.cern.ch/alice-cru/cru-sw/-/raw/clock_tree/I2C/sw/register_maps/Si5345-RevD-_local_pll-oct-2024-320M-LPGBTCRU-Registers.txt
/// cf https://its.cern.ch/jira/browse/ORC-511

std::vector<std::pair<uint32_t, uint32_t>> getORC511PllRegisterMap()
{
...
# 
# Part: Si5345
# Project File: Z:\Si5345-RevD-_local_pll-oct-2024-320M-LPGBTCRU.slabtimeproj
# Design ID: LPGBTCRU
# Includes Pre/Post Download Control Register Writes: Yes
# Die Revision: B1
# Creator: ClockBuilder Pro v4.0 [2021-07-26]
# Created On: 2024-10-11 14:41:55 GMT+02:00
Address,Data
# 
...
*/
    ...
    std::make_pair(0x0108,0x06),
    std::make_pair(0x0109,0x09),
    std::make_pair(0x010A,0x3E),
    std::make_pair(0x010B,0x18),
    std::make_pair(0x010D,0x06),
    std::make_pair(0x010E,0x09),
    std::make_pair(0x010F,0x3E),
    std::make_pair(0x0110,0x18),
    ...
    std::make_pair(0x0119,0x3E),
    std::make_pair(0x011A,0x18),
    std::make_pair(0x011C,0x01),
    std::make_pair(0x011D,0x09),
    std::make_pair(0x011E,0x3B),
    std::make_pair(0x011F,0x28),
    std::make_pair(0x0121,0x01),
    std::make_pair(0x0122,0x09),
    std::make_pair(0x0123,0x3B),
    std::make_pair(0x0124,0x28),
    std::make_pair(0x0126,0x01),
    std::make_pair(0x0127,0x09),
    std::make_pair(0x0128,0x3B),
    std::make_pair(0x0129,0x28),
    std::make_pair(0x012B,0x01),
    std::make_pair(0x012C,0x09),
    std::make_pair(0x012D,0x3B),
    std::make_pair(0x012E,0x28),
    std::make_pair(0x0130,0x06),
    std::make_pair(0x0131,0x09),
    std::make_pair(0x0132,0x3E),
    std::make_pair(0x0133,0x19),
    std::make_pair(0x013A,0x02),
    std::make_pair(0x013B,0x09),
    std::make_pair(0x013C,0x3E),
    std::make_pair(0x013D,0x18),
    std::make_pair(0x013F,0x00),
    std::make_pair(0x0140,0x08),
    std::make_pair(0x0141,0x40),
    std::make_pair(0x0142,0xFF),
    std::make_pair(0x0206,0x00),
    std::make_pair(0x0208,0x14),
    ...
    std::make_pair(0x0237,0x00),
    std::make_pair(0x0238,0x00),
    std::make_pair(0x0239,0x8C),
    std::make_pair(0x023A,0x00),
    std::make_pair(0x023B,0x00),
    std::make_pair(0x023C,0x00),
    std::make_pair(0x023D,0x00),
    std::make_pair(0x023E,0x90),
    std::make_pair(0x024A,0x00),
    std::make_pair(0x024B,0x00),
    std::make_pair(0x024C,0x00),
    std::make_pair(0x024D,0x00),
    std::make_pair(0x024E,0x00),
    std::make_pair(0x024F,0x00),
    ...
    std::make_pair(0x0256,0x00),
    std::make_pair(0x0257,0x00),
    std::make_pair(0x0258,0x00),
    std::make_pair(0x0259,0x00),
    std::make_pair(0x025A,0x00),
    std::make_pair(0x025B,0x00),
    ...
    std::make_pair(0x0262,0x00),
    std::make_pair(0x0263,0x00),
    std::make_pair(0x0264,0x00),
    std::make_pair(0x0268,0x07),
    std::make_pair(0x0269,0x00),
    std::make_pair(0x026A,0x00),
    std::make_pair(0x026B,0x4C),
    std::make_pair(0x026C,0x50),
    std::make_pair(0x026D,0x47),
    std::make_pair(0x026E,0x42),
    std::make_pair(0x026F,0x54),
    std::make_pair(0x0270,0x43),
    std::make_pair(0x0271,0x52),
    std::make_pair(0x0272,0x55),
    ...
    std::make_pair(0x0305,0x80),
    std::make_pair(0x0306,0x0A),
    ...
    std::make_pair(0x032E,0x00),
    std::make_pair(0x032F,0x00),
    std::make_pair(0x0330,0x00),
    std::make_pair(0x0331,0x00),
    std::make_pair(0x0332,0x00),
    std::make_pair(0x0333,0x00),
    std::make_pair(0x0334,0x00),
    std::make_pair(0x0335,0x00),
    std::make_pair(0x0336,0x00),
    std::make_pair(0x0337,0x00),
    ...
    std::make_pair(0x0353,0x00),
    std::make_pair(0x0354,0x00),
    std::make_pair(0x0355,0x00),
    std::make_pair(0x0356,0x00),
    std::make_pair(0x0357,0x00),
    std::make_pair(0x0358,0x00),
    ...
    std::make_pair(0x0361,0x00),
    std::make_pair(0x0362,0x00),
    std::make_pair(0x0487,0x01),
    std::make_pair(0x0508,0x10),
    std::make_pair(0x0509,0x1F),
    std::make_pair(0x050A,0x0C),
    std::make_pair(0x050B,0x0B),
    std::make_pair(0x050C,0x3F),
    std::make_pair(0x050D,0x3F),
    std::make_pair(0x050E,0x13),
    std::make_pair(0x050F,0x27),
    std::make_pair(0x0510,0x09),
    std::make_pair(0x0511,0x08),
    std::make_pair(0x0512,0x3F),
    ...
    std::make_pair(0x0519,0xA0),
    std::make_pair(0x051A,0x02),
    ...
    std::make_pair(0x0532,0x42),
    std::make_pair(0x0533,0x03),
    std::make_pair(0x0534,0x00),
    std::make_pair(0x0535,0x00),
    std::make_pair(0x0536,0x00),
    ...
    std::make_pair(0x0589,0x0D),
    std::make_pair(0x058A,0x00),
    std::make_pair(0x059B,0xEA),
    std::make_pair(0x059D,0x10),
    std::make_pair(0x059E,0x21),
    std::make_pair(0x059F,0x0C),
    std::make_pair(0x05A0,0x0B),
    std::make_pair(0x05A1,0x3F),
    std::make_pair(0x05A2,0x3F),
    std::make_pair(0x05A6,0x03),
