/// \file Si5345-RevD_local_pll2_zdb-Registers.h
/// \brief Definition of register map needed for CRU configuration
///
/// \author Kostas Alexopoulos (kostas.alexopoulos@cern.ch)

std::vector<std::pair<uint32_t, uint32_t>> getLocalClockPll2RegisterMap() {
  std::vector<std::pair<uint32_t, uint32_t>> registerMap = {

/*# Si538x/4x Registers Script
# 
# Part: Si5345
# Project File: C:\Users\Tuan\Documents\work\cern\dev\Si5345-RevD-Project_local_pll2_zdb.slabtimeproj
# Design ID: <none>
# Includes Pre/Post Download Control Register Writes: Yes
# Die Revision: B1
# Creator: ClockBuilder Pro v2.29 [2018-11-04]
# Created On: 2018-12-13 11:33:27 GMT+01:00
Address,Data
# 
...
# Start configuration registers*/
    ...
    std::make_pair(0x0018,0xE6),
    std::make_pair(0x0019,0xDD),
    std::make_pair(0x001A,0xDF),
    std::make_pair(0x002B,0x02),
    std::make_pair(0x002C,0x09),
    std::make_pair(0x002D,0x41),
    ...
    std::make_pair(0x0949,0x09),
    std::make_pair(0x094A,0x09),
    ...
    std::make_pair(0x0B47,0x06),
    std::make_pair(0x0B48,0x06),
