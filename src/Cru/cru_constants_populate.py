...
'add_gbt_link_rx_err_cnt':'GBT_LINK_RX_ERROR_COUNT',
'add_gbt_link_mask_lo':'GBT_LINK_MASK_LOW',
'add_gbt_link_mask_med':'GBT_LINK_MASK_MED',
'add_gbt_link_mask_hi':'GBT_LINK_MASK_HIGH',
'add_gbt_link_fec_monitoring':'GBT_LINK_FEC_MONITORING',
...
'add_gbt_wrapper_test_control': 'GBT_WRAPPER_TEST_CTRL',
