...
//        cout << "> Setting descriptor " << i << " to page " << i
//                  << " @ " << sourceAddress << " -> " << destinationAddress << endl;
    ...
    void runDma()
    {
      ...
      while (true) {
        ...
        if (mFifoUser->statusEntries[i].isPageArrived()) {
          ...
          if (i == 0) {
            mBar[Register::DMA_POINTER] = NUM_PAGES - 1; // Batch
          }
          //mBar[Register::DMA_POINTER] = i; // One by one
